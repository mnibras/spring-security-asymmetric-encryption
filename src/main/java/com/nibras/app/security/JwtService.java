package com.nibras.app.security;
...
public class JwtService {
    ...
    public String buildToken(final String username, final Map<String, Object> claims, final long expiration) {
        return Jwts.builder()
                ...
                .signWith(this.privateKey) // signing with private key for asymmetric encryption
                .compact();
    }
    ...
    private Claims extractClaims(final String token) {
        try {
            return Jwts.parser()
                    .verifyWith(this.publicKey) // verifying with public key for asymmetric encryption
                    .build()
