...
public class TodoMapper {
    ...
    public void mergerTodo(final Todo todoToUpdate, final TodoUpdateRequest request) {
        if (StringUtils.isNotBlank(request.getTitle()) && !todoToUpdate.getTitle().equals(request.getTitle())) {
            todoToUpdate.setTitle(request.getTitle());
        }
        if (StringUtils.isNotBlank(request.getDescription()) && !todoToUpdate.getDescription().equals(request.getDescription())) {
