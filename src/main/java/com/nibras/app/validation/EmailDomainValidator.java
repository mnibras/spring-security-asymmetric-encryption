package com.nibras.app.validation;
...
public class EmailDomainValidator implements ConstraintValidator<NonFakeEmail, String> {

    private final Set<String> blocked;

    public EmailDomainValidator(@Value("${app.security.fake-email-providers}") final List<String> domains) {
